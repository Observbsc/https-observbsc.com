...
const StyledCard = styled(Box)`
  ...
  background: ${({ theme }) =>
    theme.isDark
      ? 'linear-gradient(360deg, #06051b 0%, rgba(61, 42, 84, 0.9) 100%)'
      : 'linear-gradient(180deg, #06051b 0%,  rgba(204, 220, 239, 0.9) 51.04%, rgba(206, 236, 243, 0.9) 100%)'};
`
  ...
  return (
    <StyledCard p={['16px', null, null, '24px']}>
      <Flex alignItems="center" justifyContent="center" flexDirection={['column', null, null, 'row']}>
        ...
        <Flex flex="1" justifyContent="center" width={['100%', null, 'auto']}>
        </Flex>
      </Flex>
    </StyledCard>
  )
