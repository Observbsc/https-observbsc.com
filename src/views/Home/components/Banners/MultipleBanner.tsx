...
const BannerPlaceHolder = styled.div<{ walletConnected: boolean }>`
  ...
  &::before {
    ...
    right: 0px;
    bottom: 0px;
    background: -webkit-linear-gradient(#696969, #06051b);
    ${({ theme }) => theme.mediaQueries.sm} {
      top: 20px;
      left: 20px;
      right: 20px;
  ...
  margin-top: ${({ walletConnected }) => (walletConnected ? '100px' : '0px')};
  ...
  ${({ theme }) => theme.mediaQueries.md} {
    margin-top: ${({ walletConnected }) => (walletConnected ? '90px' : '0px')};
