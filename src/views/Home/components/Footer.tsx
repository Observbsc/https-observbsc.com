    ...
    <>
      ...
      <Wrapper>
        <Heading mb="24px" scale="xl" color="white">
          {t('Become an Observer.')}
        </Heading>
        <Text textAlign="center" color="white">
          {t('Join one of the fastest growing ecosystems that operates on Binance Smart Chain.')}
        </Text>
        <Text mb="24px" bold color="white">
          {t('Hold and become part of something big.')}
        </Text>

        <Link external href="https://observbsc.com/swap">
          {t('Join Us Now')}
        </Link>
